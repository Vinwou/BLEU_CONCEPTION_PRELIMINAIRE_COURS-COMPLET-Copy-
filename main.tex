...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\LARGE Guide pratique + exercices d'entraînements\par} % Subtitle
...
La flèche qui définit la translation s’appelle un vecteur. Un vecteur est toujours défini selon :
\begin{itemize}
    \item une direction;
    \item un sens;
    \item une longueur.
...
\draw (483.6,73.4) node  {\includegraphics[width=31.9pt,height=31.9pt]{animal.png}};
